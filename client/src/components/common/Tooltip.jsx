  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          role="tooltip"
          className={`absolute ${positionStyles[position]} z-50 px-2.5 py-1.5 text-xs font-medium text-white bg-neutral-900 dark:bg-neutral-800 border border-neutral-700 rounded-lg shadow-lg whitespace-nowrap pointer-events-none transition-all duration-150 animate-in fade-in`}
        >
          {content}
        </div>
      )}
