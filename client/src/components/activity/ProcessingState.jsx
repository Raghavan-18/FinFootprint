  ...
  return (
    <Card className={`text-center py-10 px-6 max-w-xl mx-auto space-y-6 ${className}`}>
      ...
      <div className="relative w-16 h-16 mx-auto flex items-center justify-center">
        ...
        <div className="w-14 h-14 rounded-2xl bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200 dark:border-indigo-800/40 flex items-center justify-center text-indigo-600 dark:text-indigo-400 relative z-10">
      ...
      <div>
        ...
        <p className="text-xs sm:text-sm text-neutral-500 dark:text-neutral-400 mt-1 max-w-sm mx-auto leading-relaxed">
          {subtitle || t('activity.processingSubtitle')}
        </p>
      </div>

      {/* Simulated pipeline checklist */}
      <div className="p-4 rounded-xl bg-neutral-50 dark:bg-neutral-900/60 border border-neutral-200 dark:border-neutral-800 text-xs text-left space-y-2.5 max-w-sm mx-auto">
