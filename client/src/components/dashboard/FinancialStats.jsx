  ...
  return (
    ...
    >
      ...
      <StatCard
        ...
        value={formatCurrency(stats.netMonthlyCashflow || 0)}
        description={t('dashboard.surplusDesc')}
        icon={<TrendingUp className="w-5 h-5" />}
        badge={hasData ? <Badge variant="emerald" size="sm">{t('common.healthy')}</Badge> : undefined}
      />
      ...
      <StatCard
        ...
        badge={hasData && profile?.trustGrade && profile?.trustGrade !== '—' ? <Badge variant="indigo" size="sm">{t('lenderReport.gradePrefix')} {profile.trustGrade}</Badge> : undefined}
