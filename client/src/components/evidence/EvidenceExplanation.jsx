    ...
    >
      <div className="space-y-4">
        {tiers.map((tier) => (
          <div
            key={tier.status}
            className="p-4 rounded-xl border border-neutral-100 dark:border-neutral-800 bg-neutral-50/60 dark:bg-neutral-900/40 flex flex-col sm:flex-row sm:items-start gap-4"
          >
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-neutral-200/70 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300">
      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="p-3.5 rounded-xl bg-neutral-50 dark:bg-neutral-900/40 border border-neutral-200/80 dark:border-neutral-800 flex items-center gap-2.5 text-xs text-neutral-500 dark:text-neutral-400">
